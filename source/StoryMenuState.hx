...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var purpBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFBC51F9);
		...
		{
			var weekThing:MenuItem = new MenuItem(0, purpBG.y + purpBG.height + 10, i);
		...
		txtTracklist = new FlxText(FlxG.width * 0.05, purpBG.x + purpBG.height + 100, 0, "Tracks", 32);

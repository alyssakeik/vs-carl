...
HXLINE(  75)		{
HXLINE(  75)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/carl.json",de,b2,b2,2b));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("carl",d8,1d,ba,41),v2);
            		}
HXLINE(  76)		{
HXLINE(  76)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/sm.json",dc,54,48,0c));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("sm",9a,64,00,00),v3);
            		}
HXLINE(  77)		{
...
HXLINE(  82)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  83)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  84)		if (::hx::IsNotNull( library )) {
HXLINE(  84)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  85)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE(  86)		library = ::lime::utils::Assets_obj::getLibrary(HX_("carl",d8,1d,ba,41));
HXLINE(  87)		if (::hx::IsNotNull( library )) {
HXLINE(  87)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  88)			::ManifestResources_obj::preloadLibraryNames->push(HX_("carl",d8,1d,ba,41));
            		}
HXLINE(  89)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sm",9a,64,00,00));
HXLINE(  90)		if (::hx::IsNotNull( library )) {
HXLINE(  90)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  91)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sm",9a,64,00,00));
            		}

...
HXLINE(  20)		this->week->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXDLIN(  40)		this->set_y((a + ((((Float)0.17) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))) * (((this->targetY * ( (Float)(120) )) + 480) - a))));
...
HXLINE(  47)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE(  48)				this->week->set_color(-1);
            			}
            		}
            	}

...
HXDLIN(  43)		if (!(::lime::utils::Assets_obj::exists(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("icons/icon-",5f,da,21,72) + _hx_char)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null()))) {
HXLINE(  44)			_hx_char = HX_("carl-phase-1",aa,d9,dd,da);
            		}
HXLINE(  46)		::String library1 = null();
HXDLIN(  46)		this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("icons/icon-",5f,da,21,72) + _hx_char)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),true,150,150,null(),null());
...
HXLINE(  53)		this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_2,2),0,false,this->isPlayer,null());

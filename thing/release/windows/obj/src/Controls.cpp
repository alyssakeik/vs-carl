...
static const int _hx_array_data_116e4296_144[] = {
	(int)8,(int)27,
};
static const int _hx_array_data_116e4296_145[] = {
	(int)13,(int)27,
};
...
static const int _hx_array_data_116e4296_196[] = {
	(int)7,
};
...
HXLINE( 587)		buttons->set(::Control_obj::PAUSE_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_142,1));
...
HXLINE( 595)		{
HXLINE( 595)			::Array< int > keys8 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_143,3);
...
HXLINE( 596)		{
HXLINE( 596)			::Array< int > keys9 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_144,2);
...
HXLINE( 597)		{
HXLINE( 597)			::Array< int > keys10 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_145,2);
...
HXDLIN( 663)		_g->set(::Control_obj::ACCEPT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_190,1));
HXDLIN( 663)		_g->set(::Control_obj::BACK_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_191,1));
HXDLIN( 663)		_g->set(::Control_obj::UP_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_192,2));
HXDLIN( 663)		_g->set(::Control_obj::DOWN_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_193,2));
HXDLIN( 663)		_g->set(::Control_obj::LEFT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_194,2));
HXDLIN( 663)		_g->set(::Control_obj::RIGHT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_195,2));
HXDLIN( 663)		_g->set(::Control_obj::PAUSE_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_196,1));
HXDLIN( 663)		_g->set(::Control_obj::RESET_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_197,1));

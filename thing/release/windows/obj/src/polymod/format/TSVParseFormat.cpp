...
HXLINE( 375)				buf->b = ::Array_obj< ::String >::fromData( _hx_array_data_1aa5a3f2_11,1);
            			}
            			else {
...
HXLINE( 397)						buf->b = ::Array_obj< ::String >::fromData( _hx_array_data_1aa5a3f2_12,1);
            					}
            					else {

...
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_53_updateBeat,"MusicBeatSubstate","updateBeat",0x52ba7d01,"MusicBeatSubstate.updateBeat","MusicBeatSubstate.hx",53,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_59_updateCurStep,"MusicBeatSubstate","updateCurStep",0x817e4641,"MusicBeatSubstate.updateCurStep","MusicBeatSubstate.hx",59,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_76_stepHit,"MusicBeatSubstate","stepHit",0x3b6b7c45,"MusicBeatSubstate.stepHit","MusicBeatSubstate.hx",76,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_81_beatHit,"MusicBeatSubstate","beatHit",0x2e2eb85b,"MusicBeatSubstate.beatHit","MusicBeatSubstate.hx",81,0x55a559f2)
...
HXLINE(  27)		int nextStep = this->updateCurStep();
HXLINE(  29)		if ((nextStep >= 0)) {
HXLINE(  31)			if ((nextStep > this->curStep)) {
HXLINE(  33)				int _g = this->curStep;
HXDLIN(  33)				int _g1 = nextStep;
HXDLIN(  33)				while((_g < _g1)){
HXLINE(  33)					_g = (_g + 1);
HXDLIN(  33)					int i = (_g - 1);
HXLINE(  35)					this->curStep++;
HXLINE(  36)					this->updateBeat();
HXLINE(  37)					this->stepHit();
            				}
            			}
            			else {
HXLINE(  40)				if ((nextStep < this->curStep)) {
HXLINE(  43)					this->curStep = nextStep;
HXLINE(  44)					this->updateBeat();
...
void MusicBeatSubstate_obj::updateBeat(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_53_updateBeat)
HXLINE(  54)		this->lastBeat = ( (Float)(this->curBeat) );
HXLINE(  55)		this->curBeat = ::Math_obj::floor((( (Float)(this->curStep) ) / ( (Float)(4) )));
            	}
...
int MusicBeatSubstate_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_59_updateCurStep)
HXLINE(  60)		 ::Dynamic lastChange =  ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("stepTime",79,75,25,a0),0)
            			->setFixed(1,HX_("bpm",df,be,4a,00),( (Float)(0) ))
            			->setFixed(2,HX_("songTime",82,2a,d5,3a),( (Float)(0) )));
HXLINE(  65)		{
HXLINE(  65)			int _g = 0;
HXDLIN(  65)			int _g1 = ::Conductor_obj::bpmChangeMap->length;
HXDLIN(  65)			while((_g < _g1)){
HXLINE(  65)				_g = (_g + 1);
HXDLIN(  65)				int i = (_g - 1);
HXLINE(  67)				if (::hx::IsGreater( ::Conductor_obj::songPosition,::Conductor_obj::bpmChangeMap->__get(i)->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic) )) {
HXLINE(  68)					lastChange = ::Conductor_obj::bpmChangeMap->__get(i);
            				}
            			}
            		}
HXLINE(  71)		return ( (int)((lastChange->__Field(HX_("stepTime",79,75,25,a0),::hx::paccDynamic) + ::Math_obj::floor(((::Conductor_obj::songPosition - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ::Conductor_obj::stepCrochet)))) );
            	}
...
void MusicBeatSubstate_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_76_stepHit)
HXDLIN(  76)		if ((::hx::Mod(this->curStep,4) == 0)) {
HXLINE(  77)			this->beatHit();
            		}
            	}
...
void MusicBeatSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_81_beatHit)
            	}

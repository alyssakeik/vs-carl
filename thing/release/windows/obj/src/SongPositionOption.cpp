...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_210_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",210,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_215_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",215,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_223_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",223,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_210_new)
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_215_press)
HXLINE( 216)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_223_updateDisplay)
HXDLIN( 223)		::String _hx_tmp;
HXDLIN( 223)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 223)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 223)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 223)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}

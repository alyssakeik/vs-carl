...
HX_DEFINE_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_826_new,"LockWeeksOption","new",0x229485fb,"LockWeeksOption.new","Options.hx",826,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_836_press,"LockWeeksOption","press",0x8495e5de,"LockWeeksOption.press","Options.hx",836,0x9d9a0240)
static const bool _hx_array_data_f0cd6c89_2[] = {
	1,1,
};
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_853_updateDisplay,"LockWeeksOption","updateDisplay",0x41787494,"LockWeeksOption.updateDisplay","Options.hx",853,0x9d9a0240)

void LockWeeksOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_826_new)
HXLINE( 828)		this->confirm = false;
HXLINE( 832)		super::__construct();
HXLINE( 833)		this->description = desc;
            	}
...
bool LockWeeksOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_836_press)
HXLINE( 837)		if (!(this->confirm)) {
HXLINE( 839)			this->confirm = true;
HXLINE( 840)			this->display = this->updateDisplay();
HXLINE( 841)			return true;
            		}
HXLINE( 843)		::flixel::FlxG_obj::save->data->__SetField(HX_("weekUnlocked",37,64,c4,a5),1,::hx::paccDynamic);
HXLINE( 844)		::StoryMenuState_obj::weekUnlocked = ::Array_obj< bool >::fromData( _hx_array_data_f0cd6c89_2,2);
HXLINE( 845)		this->confirm = false;
HXLINE( 847)		this->display = this->updateDisplay();
HXLINE( 848)		return true;
            	}


::String LockWeeksOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_853_updateDisplay)
HXDLIN( 853)		if (this->confirm) {
HXDLIN( 853)			return HX_("Confirm Story Reset",e4,1f,01,6b);
            		}
            		else {
HXDLIN( 853)			return HX_("Reset Story Progress",c9,28,76,d8);
            		}
HXDLIN( 853)		return null();
            	}

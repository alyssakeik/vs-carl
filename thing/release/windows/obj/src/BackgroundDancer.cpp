...
HX_DEFINE_STACK_FRAME(_hx_pos_d86c65e08c62e087_7_new,"BackgroundDancer","new",0x54563fff,"BackgroundDancer.new","BackgroundDancer.hx",7,0x2f720451)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d86c65e08c62e087_25_dance,"BackgroundDancer","dance",0x01b85892,"BackgroundDancer.dance","BackgroundDancer.hx",25,0x2f720451)

void BackgroundDancer_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_d86c65e08c62e087_7_new)
HXLINE(  22)		this->danceDir = false;
HXLINE(  11)		super::__construct(x,y,null());
HXLINE(  13)		bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN(  13)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week4",c0,95,be,c7));
HXDLIN(  13)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week4",c0,95,be,c7))));
HXLINE(  14)		this->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("bg dancer sketch PINK",64,fb,2b,a2),::Array_obj< int >::fromData( _hx_array_data_0320d48d_1,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  15)		this->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("bg dancer sketch PINK",64,fb,2b,a2),::Array_obj< int >::fromData( _hx_array_data_0320d48d_2,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  16)		this->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
HXLINE(  17)		this->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
            	}
...
void BackgroundDancer_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_d86c65e08c62e087_25_dance)
HXLINE(  26)		this->danceDir = !(this->danceDir);
HXLINE(  28)		if (this->danceDir) {
HXLINE(  29)			this->animation->play(HX_("danceRight",a9,7f,a6,91),true,null(),null());
            		}
            		else {
HXLINE(  31)			this->animation->play(HX_("danceLeft",da,cc,f9,df),true,null(),null());
            		}
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_6ae35d7392f0592b_55_new,"Replay","new",0xf50eabb9,"Replay.new","Replay.hx",55,0xac25edd7)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae35d7392f0592b_92_SaveReplay,"Replay","SaveReplay",0xc69ca82b,"Replay.SaveReplay","Replay.hx",92,0xac25edd7)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae35d7392f0592b_133_LoadFromJSON,"Replay","LoadFromJSON",0x580c567f,"Replay.LoadFromJSON","Replay.hx",133,0xac25edd7)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae35d7392f0592b_81_LoadReplay,"Replay","LoadReplay",0x330e4bd4,"Replay.LoadReplay","Replay.hx",81,0xac25edd7)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae35d7392f0592b_57_boot,"Replay","boot",0x6fe096b9,"Replay.boot","Replay.hx",57,0xac25edd7)

void Replay_obj::__construct(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6ae35d7392f0592b_55_new)
HXLINE(  59)		this->path = HX_("",00,00,00,00);
HXLINE(  63)		this->path = path;
HXLINE(  70)		::String _hx_tmp = ::Replay_obj::version;
HXLINE(  73)		 ::Date _hx_tmp1 = ::Date_obj::now();
HXLINE(  74)		int _hx_tmp2 = ::Conductor_obj::safeFrames;
HXLINE(  64)		this->replay =  ::Dynamic(::hx::Anon_obj::Create(12)
...
void Replay_obj::SaveReplay(::cpp::VirtualArray notearray,::Array< ::String > judge, ::Analysis ana){
            	HX_STACKFRAME(&_hx_pos_6ae35d7392f0592b_92_SaveReplay)
HXLINE(  94)		::String chartPath;
HXDLIN(  94)		if (::PlayState_obj::isSM) {
HXLINE(  94)			chartPath = (::PlayState_obj::pathToSm + HX_("/converted.json",73,2b,b3,66));
            		}
            		else {
HXLINE(  94)			chartPath = HX_("",00,00,00,00);
            		}
HXLINE( 100)		::String json = ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) );
HXLINE( 101)		int json1 = ::PlayState_obj::storyDifficulty;
HXLINE( 103)		bool json2 = ::PlayState_obj::isSM;
HXLINE( 104)		 ::Date json3 = ::Date_obj::now();
HXLINE( 107)		Float json4;
HXDLIN( 107)		if (::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic),1 )) {
HXLINE( 107)			json4 = ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 107)			json4 = ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) );
            		}
HXLINE(  99)		 ::Dynamic json5 =  ::Dynamic(::hx::Anon_obj::Create(12)
            			->setFixed(0,HX_("timestamp",d6,d4,ce,a5),json3)
            			->setFixed(1,HX_("noteSpeed",35,e2,f6,be),json4)
            			...
            			->setFixed(5,HX_("sm",9a,64,00,00),json2)
            			...
            			->setFixed(9,HX_("songDiff",7a,ba,41,30),json1)
            			->setFixed(10,HX_("songName",c0,d0,d7,36),json)
            			->setFixed(11,HX_("songJudgements",53,36,93,44),judge));
HXLINE( 114)		 ::Dynamic replacer = null();
HXDLIN( 114)		::String data = ::haxe::format::JsonPrinter_obj::print(json5,replacer,HX_("",00,00,00,00));
HXLINE( 116)		Float time = ::Date_obj::now()->getTime();
HXLINE( 119)		::sys::io::File_obj::saveContent(( (::String)(((((HX_("assets/replays/replay-",77,41,6e,f6) + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) + HX_("-time",ba,e6,04,36)) + time) + HX_(".kadeReplay",cc,f2,52,6f))) ),data);
HXLINE( 121)		this->path = ( (::String)(((((HX_("replay-",26,5b,28,ab) + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) + HX_("-time",ba,e6,04,36)) + time) + HX_(".kadeReplay",cc,f2,52,6f))) );
HXLINE( 123)		this->LoadFromJSON();
HXLINE( 125)		this->replay->__SetField(HX_("ana",d4,fa,49,00),ana,::hx::paccDynamic);
            	}
...
void Replay_obj::LoadFromJSON(){
            	HX_GC_STACKFRAME(&_hx_pos_6ae35d7392f0592b_133_LoadFromJSON)
HXDLIN( 133)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 135)			::String text = (::Sys_obj::getCwd() + HX_("assets/replays/",8f,f9,e8,c5));
HXDLIN( 135)			 ::Dynamic repl =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::sys::io::File_obj::getContent((text + this->path)))->doParse();
HXLINE( 136)			this->replay = repl;
            		} catch( ::Dynamic _hx_e) {
...
::String Replay_obj::version;
 ...
 ::Replay Replay_obj::LoadReplay(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6ae35d7392f0592b_81_LoadReplay)
HXLINE(  82)		 ::Replay rep =  ::Replay_obj::__alloc( HX_CTX ,path);
HXLINE(  84)		rep->LoadFromJSON();
HXLINE(  88)		return rep;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6ae35d7392f0592b_57_boot)
HXDLIN(  57)		version = HX_("1.2",b5,56,25,00);
            	}
}

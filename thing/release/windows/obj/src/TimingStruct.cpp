...
HX_LOCAL_STACK_FRAME(_hx_pos_2bef5994c8f2a111_60_getTimingAtTimestamp,"TimingStruct","getTimingAtTimestamp",0x8761c9b2,"TimingStruct.getTimingAtTimestamp","TimingStruct.hx",60,0x0c959f7f)
HX_LOCAL_STACK_FRAME(_hx_pos_2bef5994c8f2a111_70_getTimingAtBeat,"TimingStruct","getTimingAtBeat",0xdd9d1a1a,"TimingStruct.getTimingAtBeat","TimingStruct.hx",70,0x0c959f7f)
...
HXLINE(  53)		this->startBeat = startBeat;
HXLINE(  54)		if ((endBeat != -1)) {
HXLINE(  55)			this->endBeat = endBeat;
            		}
HXLINE(  56)		this->startTime = offset;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TimingStruct_obj,getTimeFromBeat,return )
 ...
 ::TimingStruct TimingStruct_obj::getTimingAtTimestamp(Float msTime){
            	HX_STACKFRAME(&_hx_pos_2bef5994c8f2a111_60_getTimingAtTimestamp)
HXLINE(  61)		{
HXLINE(  61)			int _g = 0;
HXDLIN(  61)			::Array< ::Dynamic> _g1 = ::TimingStruct_obj::AllTimings;
HXDLIN(  61)			while((_g < _g1->length)){
HXLINE(  61)				 ::TimingStruct i = _g1->__get(_g).StaticCast<  ::TimingStruct >();
HXDLIN(  61)				_g = (_g + 1);
HXLINE(  63)				bool _hx_tmp;
HXDLIN(  63)				if ((msTime >= (i->startTime * ( (Float)(1000) )))) {
HXLINE(  63)					_hx_tmp = (msTime < ((i->startTime + i->length) * ( (Float)(1000) )));
            				}
            				else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TimingStruct_obj,getTimingAtTimestamp,return )
 ...
 ::TimingStruct TimingStruct_obj::getTimingAtBeat(Float beat){
            	HX_STACKFRAME(&_hx_pos_2bef5994c8f2a111_70_getTimingAtBeat)
HXLINE(  71)		{
HXLINE(  71)			int _g = 0;
HXDLIN(  71)			::Array< ::Dynamic> _g1 = ::TimingStruct_obj::AllTimings;
HXDLIN(  71)			while((_g < _g1->length)){
HXLINE(  71)				 ::TimingStruct i = _g1->__get(_g).StaticCast<  ::TimingStruct >();
HXDLIN(  71)				_g = (_g + 1);
HXLINE(  73)				bool _hx_tmp;
HXDLIN(  73)				if ((i->startBeat <= beat)) {
HXLINE(  73)					_hx_tmp = (i->endBeat >= beat);
            				}
            				else {

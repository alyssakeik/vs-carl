...
HX_LOCAL_STACK_FRAME(_hx_pos_badf7fe26ae152fc_83_create,"OutdatedSubState","create",0xa86f5ef1,"OutdatedSubState.create","OutdatedSubState.hx",83,0x9d3df485)
...
HX_LOCAL_STACK_FRAME(_hx_pos_badf7fe26ae152fc_95_update,"OutdatedSubState","update",0xb3657dfe,"OutdatedSubState.update","OutdatedSubState.hx",95,0x9d3df485)
...
HXLINE(  76)			 ::flixel::FlxSprite bg = bg1;
HXDLIN(  76)			int bg2 = bg1->color;
HXDLIN(  76)			::flixel::tweens::FlxTween_obj::color(bg,2,bg2,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(_gthis->bgColors->__get(_gthis->colorRotation))) ),null());
HXLINE(  77)			if ((_gthis->colorRotation < (_gthis->bgColors->length - 1))) {
HXLINE(  77)				_gthis->colorRotation++;
            			}
            			else {
HXLINE(  78)				_gthis->colorRotation = 0;
            			}
            		}
            		...
            		void _hx_run( ::flixel::util::FlxTimer tmr){
            			HX_GC_STACKFRAME(&_hx_pos_badf7fe26ae152fc_83_create)
HXLINE(  83)			if ((kadeLogo1->angle == -10)) {
HXLINE(  83)				::flixel::tweens::FlxTween_obj::angle(kadeLogo1,kadeLogo1->angle,( (Float)(10) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE(  89)				::flixel::tweens::FlxTween_obj::tween(kadeLogo1, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE(  35)		bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  36)		this->add(bg1);
HXLINE(  38)		 ::flixel::FlxSprite kadeLogo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::width,0,null());
HXDLIN(  38)		::String library = null();
HXDLIN(  38)		 ::flixel::FlxSprite kadeLogo1 = kadeLogo->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("KadeEngineLogo",e4,3d,f0,db)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  39)		kadeLogo1->scale->set_y(((Float)0.3));
HXLINE(  40)		kadeLogo1->scale->set_x(((Float)0.3));
HXLINE(  41)		{
HXLINE(  41)			 ::flixel::FlxSprite _g2 = kadeLogo1;
HXDLIN(  41)			_g2->set_x((_g2->x - ( (Float)(kadeLogo1->frameHeight) )));
            		}
HXLINE(  42)		{
HXLINE(  42)			 ::flixel::FlxSprite _g3 = kadeLogo1;
HXDLIN(  42)			_g3->set_y((_g3->y - ( (Float)(180) )));
            		}
HXLINE(  43)		kadeLogo1->set_alpha(((Float)0.8));
HXLINE(  44)		kadeLogo1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  45)		this->add(kadeLogo1);
HXLINE(  47)		 ::flixel::text::FlxText txt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((((((HX_("Your Kade Engine is outdated!\nYou are on ",ef,8f,d4,e3) + ::MainMenuState_obj::kadeEngineVer) + HX_("\nwhile the most recent version is ",7e,e9,4d,24)) + ::OutdatedSubState_obj::needVer) + HX_(".",2e,00,00,00)) + HX_("\n\nWhat's new:\n\n",aa,75,7b,45)) + ::OutdatedSubState_obj::currChanges) + HX_("\n& more changes and bugfixes in the full changelog",e9,8d,8a,28)) + HX_("\n\nPress Space to view the full changelog and update\nor ESCAPE to ignore this",a0,9c,e2,cd)),32,null());
HXLINE(  57)		if ((::MainMenuState_obj::nightly != HX_("",00,00,00,00))) {
HXLINE(  58)			txt->set_text((((HX_("You are on\n",de,aa,85,4f) + ::MainMenuState_obj::kadeEngineVer) + HX_("\nWhich is a PRE-RELEASE BUILD!",9e,03,2b,c3)) + HX_("\n\nReport all bugs to the author of the pre-release.\nSpace/Escape ignores this.",f3,bf,e5,46)));
            		}
HXLINE(  64)		int Alpha = 255;
HXDLIN(  64)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN(  64)		{
HXLINE(  64)			color = (color & -16711681);
HXDLIN(  64)			color = (color | 13107200);
            		}
HXDLIN(  64)		{
HXLINE(  64)			color = (color & -65281);
HXDLIN(  64)			color = (color | 51200);
            		}
HXDLIN(  64)		{
HXLINE(  64)			color = (color & -256);
HXDLIN(  64)			color = (color | 200);
            		}
HXDLIN(  64)		{
HXLINE(  64)			color = (color & 16777215);
HXDLIN(  64)			int color1;
HXDLIN(  64)			if ((Alpha > 255)) {
HXLINE(  64)				color1 = 255;
            			}
            			else {
HXLINE(  64)				if ((Alpha < 0)) {
HXLINE(  64)					color1 = 0;
            				}
            				else {
HXLINE(  64)					color1 = Alpha;
            				}
            			}
HXDLIN(  64)			color = (color | (color1 << 24));
            		}
HXDLIN(  64)		txt->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),32,color,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  65)		txt->set_borderColor(-16777216);
HXLINE(  66)		txt->set_borderSize(( (Float)(3) ));
HXLINE(  67)		txt->set_borderStyle(::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn());
HXLINE(  68)		txt->screenCenter(null());
HXLINE(  69)		this->add(txt);
HXLINE(  71)		 ::flixel::FlxSprite bg2 = bg1;
HXDLIN(  71)		int bg3 = bg1->color;
HXDLIN(  71)		::flixel::tweens::FlxTween_obj::color(bg2,2,bg3,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(this->bgColors->__get(this->colorRotation))) ),null());
HXLINE(  72)		::flixel::tweens::FlxTween_obj::angle(kadeLogo1,kadeLogo1->angle,( (Float)(-10) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::quartInOut_dyn())));
HXLINE(  74)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(_gthis,bg1)),0);
HXLINE(  81)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_1(kadeLogo1)),0);
...
void OutdatedSubState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_badf7fe26ae152fc_95_update)
HXLINE(  96)		bool _hx_tmp;
HXDLIN(  96)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  96)			_hx_tmp = (::MainMenuState_obj::nightly == HX_("",00,00,00,00));
            		}
            		else {
HXLINE(  96)			_hx_tmp = false;
            		}
HXDLIN(  96)		if (_hx_tmp) {
HXLINE(  98)			this->fancyOpenURL((HX_("https://kadedev.github.io/Kade-Engine/changelogs/changelog-",f5,d4,9e,ab) + ::OutdatedSubState_obj::needVer));
            		}
            		else {
HXLINE( 100)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 102)				::OutdatedSubState_obj::leftState = true;
HXLINE( 103)				{
HXLINE( 103)					 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 103)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 103)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            			}
            		}
HXLINE( 105)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 107)			::OutdatedSubState_obj::leftState = true;
HXLINE( 108)			{

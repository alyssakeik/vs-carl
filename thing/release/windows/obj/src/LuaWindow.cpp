...
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1619_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1619,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1628_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1628,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1638_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1638,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1647_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1647,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1656_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1656,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1660_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1660,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1612_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1612,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1686_SetNumProperty,"LuaWindow","SetNumProperty",0xe4d61e5f,"LuaWindow.SetNumProperty","LuaClass.hx",1686,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1699_Register,"LuaWindow","Register",0xbf313009,"LuaWindow.Register","LuaClass.hx",1699,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1669_tweenPos,"LuaWindow","tweenPos",0x26ac4d6f,"LuaWindow.tweenPos","LuaClass.hx",1669,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1684_boot,"LuaWindow","boot",0x955896b8,"LuaWindow.boot","LuaClass.hx",1684,0xe0a4e33e)

void LuaWindow_obj::__construct(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1619_new)
HXLINE(1620)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___x) ));
HXLINE(1621)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1628_new)
HXLINE(1629)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___y) ));
HXLINE(1630)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1638_new)
HXLINE(1639)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___width) ));
HXLINE(1640)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_3) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1647_new)
HXLINE(1648)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___height) ));
HXLINE(1649)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_4) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1656_new)
HXLINE(1657)			linc::lua::pushcfunction(l,::LuaWindow_obj::tweenPosC);
HXLINE(1658)			return 1;
            		...
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1660_new)
HXLINE(1661)			linc::lual::error(l,HX_("tweenPos is read-only.",ca,97,f3,17));
HXLINE(1662)			return 0;
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1612_new)
HXLINE(1613)		super::__construct();
HXLINE(1614)		this->className = HX_("Window",10,08,21,87);
HXLINE(1616)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(1616)		_g->set(HX_("x",78,00,00,00), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1616)		_g->set(HX_("y",79,00,00,00), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1616)		_g->set(HX_("width",06,b6,62,ca), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1616)		_g->set(HX_("height",e7,07,4c,02), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1616)		_g->set(HX_("tweenPos",e9,7f,cc,11), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1616)		this->properties = _g;
            	}
...
int LuaWindow_obj::SetNumProperty( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1686_SetNumProperty)
HXLINE(1691)		if ((lua_type(l,3) != 3)) {
HXLINE(1692)			linc::lual::error(l,((HX_("invalid argument #3 (number expected, got ",25,84,c0,d9) + linc::lua::_typename(l,lua_type(l,3))) + HX_(")",29,00,00,00)));
HXLINE(1693)			return 0;
            		}
HXLINE(1695)		 ::lime::ui::Window _hx_tmp = ::lime::app::Application_obj::current->_hx___window;
HXDLIN(1695)		::String _hx_tmp1 = linc::lua::tostring(l,2);
HXDLIN(1695)		::Reflect_obj::setProperty(_hx_tmp,_hx_tmp1,lua_tonumber(l,3));
...
void LuaWindow_obj::Register( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1699_Register)
HXLINE(1700)		::LuaWindow_obj::state = l;
HXLINE(1701)		this->super::Register(l);
            	}
...
int LuaWindow_obj::tweenPos( lua_State* l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1669_tweenPos)
HXLINE(1674)		Float xp = luaL_checknumber(::LuaWindow_obj::state,2);
HXLINE(1675)		Float yp = luaL_checknumber(::LuaWindow_obj::state,3);
HXLINE(1676)		Float time = luaL_checknumber(::LuaWindow_obj::state,4);
HXLINE(1678)		::flixel::tweens::FlxTween_obj::tween(::lime::app::Application_obj::current->_hx___window, ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("x",78,00,00,00),xp)
            			->setFixed(1,HX_("y",79,00,00,00),yp)),time,null());
HXLINE(1680)		return 0;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1684_boot)
HXDLIN(1684)		tweenPosC = ::cpp::Function< int ( lua_State*)>(::hx::AnyCast(&::LuaWindow_obj::tweenPos ));
            	}
}

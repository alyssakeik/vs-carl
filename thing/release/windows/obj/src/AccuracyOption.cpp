...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_190_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",190,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_195_press,"AccuracyOption","press",0x7bacf5c3,"AccuracyOption.press","Options.hx",195,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_203_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",203,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_190_new)
...
bool AccuracyOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_195_press)
HXLINE( 196)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_203_updateDisplay)
HXDLIN( 203)		::String _hx_tmp;
HXDLIN( 203)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 203)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 203)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 203)		return (HX_("Accuracy ",a7,4b,73,6e) + _hx_tmp);
            	}

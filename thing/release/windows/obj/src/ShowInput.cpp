...
HX_DEFINE_STACK_FRAME(_hx_pos_635a2d013c5acddb_391_new,"ShowInput","new",0x331b851f,"ShowInput.new","Options.hx",391,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_396_press,"ShowInput","press",0x0435f602,"ShowInput.press","Options.hx",396,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_404_updateDisplay,"ShowInput","updateDisplay",0x219b48b8,"ShowInput.updateDisplay","Options.hx",404,0x9d9a0240)

void ShowInput_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_391_new)
HXLINE( 392)		super::__construct();
HXLINE( 393)		this->description = desc;
            	}
...
bool ShowInput_obj::press(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_396_press)
HXLINE( 397)		::flixel::FlxG_obj::save->data->__SetField(HX_("inputShow",27,92,7d,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 398)		this->display = this->updateDisplay();
HXLINE( 399)		return true;
            	}


::String ShowInput_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_404_updateDisplay)
HXDLIN( 404)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )) {
HXDLIN( 404)			return HX_("Extended Score Info",23,00,94,83);
            		}
            		else {
HXDLIN( 404)			return HX_("Minimalized Info",bd,6b,6e,01);
            		}
HXDLIN( 404)		return null();
            	}

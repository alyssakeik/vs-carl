...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_718_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",718,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_724_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",724,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_732_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",732,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_718_new)
HXLINE( 719)		super::__construct();
HXLINE( 720)		this->description = desc;
            	}
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_724_press)
HXLINE( 726)		{
HXLINE( 726)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 726)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 726)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_732_updateDisplay)
HXDLIN( 732)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}

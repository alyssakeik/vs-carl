...
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_281_chisel,"DiffCalc","chisel",0x5148a28a,"DiffCalc.chisel","DiffCalc.hx",281,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_299_calcuate,"DiffCalc","calcuate",0x92bbdd66,"DiffCalc.calcuate","DiffCalc.hx",299,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_314_findStupid,"DiffCalc","findStupid",0x6d0c39c4,"DiffCalc.findStupid","DiffCalc.hx",314,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_322_fingieCalc,"DiffCalc","fingieCalc",0xf18bd061,"DiffCalc.fingieCalc","DiffCalc.hx",322,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_344_smoothBrain,"DiffCalc","smoothBrain",0x0610b894,"DiffCalc.smoothBrain","DiffCalc.hx",344,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_362_smoothBrainTwo,"DiffCalc","smoothBrainTwo",0x25460158,"DiffCalc.smoothBrainTwo","DiffCalc.hx",362,0x0b7f13a4)
...
HXLINE( 107)		Float length = ((cleanedNotes->__get((cleanedNotes->length - 1)).StaticCast<  ::SmallNote >()->strumTime / ( (Float)(1000) )) / ((Float)0.5));
HXLINE( 110)		::Array< ::Dynamic> this1 = ::Array_obj< ::Dynamic>::__new(::Math_obj::floor(length));
HXDLIN( 110)		::Array< ::Dynamic> segmentsOne = this1;
HXLINE( 112)		::Array< ::Dynamic> this2 = ::Array_obj< ::Dynamic>::__new(::Math_obj::floor(length));
HXDLIN( 112)		::Array< ::Dynamic> segmentsTwo = this2;
HXLINE( 116)		{
HXLINE( 116)			int _g8 = 0;
HXDLIN( 116)			int _g9 = segmentsOne->length;
HXDLIN( 116)			while((_g8 < _g9)){
HXLINE( 116)				_g8 = (_g8 + 1);
HXDLIN( 116)				int i = (_g8 - 1);
HXLINE( 117)				{
HXLINE( 117)					::Array< ::Dynamic> val = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 117)					segmentsOne->__unsafe_set(i,val);
            				}
            			}
            		}
HXLINE( 118)		{
HXLINE( 118)			int _g10 = 0;
HXDLIN( 118)			int _g11 = segmentsTwo->length;
HXDLIN( 118)			while((_g10 < _g11)){
HXLINE( 118)				_g10 = (_g10 + 1);
HXDLIN( 118)				int i = (_g10 - 1);
HXLINE( 119)				{
HXLINE( 119)					::Array< ::Dynamic> val = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 119)					segmentsTwo->__unsafe_set(i,val);
            				}
            			}
            		}
HXLINE( 122)		{
HXLINE( 122)			int _g12 = 0;
HXDLIN( 122)			while((_g12 < handOne->length)){
HXLINE( 122)				 ::SmallNote i = handOne->__get(_g12).StaticCast<  ::SmallNote >();
HXDLIN( 122)				_g12 = (_g12 + 1);
HXLINE( 124)				int index = ::Std_obj::_hx_int(((i->strumTime * ( (Float)(2) )) / ( (Float)(1000) )));
HXLINE( 125)				if (((index + 1) > length)) {
HXLINE( 126)					continue;
            				}
HXLINE( 127)				( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsOne,index)) )->push(i);
            			}
            		}
HXLINE( 130)		{
HXLINE( 130)			int _g13 = 0;
HXDLIN( 130)			while((_g13 < handTwo->length)){
HXLINE( 130)				 ::SmallNote i = handTwo->__get(_g13).StaticCast<  ::SmallNote >();
HXDLIN( 130)				_g13 = (_g13 + 1);
HXLINE( 132)				int index = ::Std_obj::_hx_int(((i->strumTime * ( (Float)(2) )) / ( (Float)(1000) )));
HXLINE( 133)				if (((index + 1) > length)) {
HXLINE( 134)					continue;
            				}
HXLINE( 135)				( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,index)) )->push(i);
            			}
            		}
HXLINE( 153)		::Array< Float > hand_npsOne = ::Array_obj< Float >::__new();
HXLINE( 154)		::Array< Float > hand_npsTwo = ::Array_obj< Float >::__new();
HXLINE( 156)		{
HXLINE( 156)			int _g14 = 0;
HXDLIN( 156)			while((_g14 < segmentsOne->length)){
HXLINE( 156)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsOne,_g14)) );
HXDLIN( 156)				_g14 = (_g14 + 1);
HXLINE( 158)				if (::hx::IsNull( i )) {
HXLINE( 159)					continue;
            				}
HXLINE( 160)				hand_npsOne->push(((( (Float)(i->length) ) * ::DiffCalc_obj::scale) * ((Float)1.6)));
            			}
            		}
HXLINE( 162)		{
HXLINE( 162)			int _g15 = 0;
HXDLIN( 162)			while((_g15 < segmentsTwo->length)){
HXLINE( 162)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,_g15)) );
HXDLIN( 162)				_g15 = (_g15 + 1);
HXLINE( 164)				if (::hx::IsNull( i )) {
HXLINE( 165)					continue;
            				}
HXLINE( 166)				hand_npsTwo->push(((( (Float)(i->length) ) * ::DiffCalc_obj::scale) * ((Float)1.6)));
            			}
            		}
HXLINE( 171)		::Array< Float > hand_diffOne = ::Array_obj< Float >::__new();
HXLINE( 172)		::Array< Float > hand_diffTwo = ::Array_obj< Float >::__new();
HXLINE( 174)		{
HXLINE( 174)			int _g16 = 0;
HXDLIN( 174)			int _g17 = segmentsOne->length;
HXDLIN( 174)			while((_g16 < _g17)){
HXLINE( 174)				_g16 = (_g16 + 1);
HXDLIN( 174)				int i = (_g16 - 1);
HXLINE( 176)				::Array< ::Dynamic> ve = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsOne,i)) );
HXLINE( 177)				if (::hx::IsNull( ve )) {
HXLINE( 178)					continue;
            				}
HXLINE( 179)				::Array< ::Dynamic> fuckYouOne = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 180)				::Array< ::Dynamic> fuckYouTwo = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 181)				{
HXLINE( 181)					int _g = 0;
HXDLIN( 181)					while((_g < ve->length)){
HXLINE( 181)						 ::SmallNote note = ve->__get(_g).StaticCast<  ::SmallNote >();
HXDLIN( 181)						_g = (_g + 1);
HXLINE( 183)						switch((int)(note->noteData)){
            							case (int)0: {
HXLINE( 186)								fuckYouOne->push(note);
            							}
            							break;
            							case (int)1: {
HXLINE( 188)								fuckYouTwo->push(note);
            							}
            							break;
            						}
            					}
            				}
HXLINE( 192)				Float one = ::DiffCalc_obj::fingieCalc(fuckYouOne,leftHandCol);
HXLINE( 193)				Float two = ::DiffCalc_obj::fingieCalc(fuckYouTwo,leftMHandCol);
HXLINE( 196)				Float bigFuck;
HXDLIN( 196)				if ((one > two)) {
HXLINE( 196)					bigFuck = one;
            				}
            				else {
HXLINE( 196)					bigFuck = two;
            				}
HXDLIN( 196)				Float bigFuck1 = ((((bigFuck * ( (Float)(8) )) + ((hand_npsOne->__get(i) / ::DiffCalc_obj::scale) * ( (Float)(5) ))) / ( (Float)(13) )) * ::DiffCalc_obj::scale);
HXLINE( 201)				hand_diffOne->push(bigFuck1);
            			}
            		}
HXLINE( 204)		{
HXLINE( 204)			int _g18 = 0;
HXDLIN( 204)			int _g19 = segmentsTwo->length;
HXDLIN( 204)			while((_g18 < _g19)){
HXLINE( 204)				_g18 = (_g18 + 1);
HXDLIN( 204)				int i = (_g18 - 1);
HXLINE( 206)				::Array< ::Dynamic> ve = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,i)) );
HXLINE( 207)				if (::hx::IsNull( ve )) {
HXLINE( 208)					continue;
            				}
HXLINE( 209)				::Array< ::Dynamic> fuckYouOne = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 210)				::Array< ::Dynamic> fuckYouTwo = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 211)				{
HXLINE( 211)					int _g = 0;
HXDLIN( 211)					while((_g < ve->length)){
HXLINE( 211)						 ::SmallNote note = ve->__get(_g).StaticCast<  ::SmallNote >();
HXDLIN( 211)						_g = (_g + 1);
HXLINE( 213)						switch((int)(note->noteData)){
            							case (int)2: {
HXLINE( 216)								fuckYouOne->push(note);
            							}
            							break;
            							case (int)3: {
HXLINE( 218)								fuckYouTwo->push(note);
            							}
            							break;
            						}
            					}
            				}
HXLINE( 222)				Float one = ::DiffCalc_obj::fingieCalc(fuckYouOne,rightMHandCol);
HXLINE( 223)				Float two = ::DiffCalc_obj::fingieCalc(fuckYouTwo,rightHandCol);
HXLINE( 225)				Float bigFuck;
HXDLIN( 225)				if ((one > two)) {
HXLINE( 225)					bigFuck = one;
            				}
            				else {
HXLINE( 225)					bigFuck = two;
            				}
HXDLIN( 225)				Float bigFuck1 = ((((bigFuck * ( (Float)(8) )) + ((hand_npsTwo->__get(i) / ::DiffCalc_obj::scale) * ( (Float)(5) ))) / ( (Float)(13) )) * ::DiffCalc_obj::scale);
HXLINE( 227)				hand_diffTwo->push(bigFuck1);
            			}
            		}
HXLINE( 232)		{
HXLINE( 233)			{
HXLINE( 234)				::DiffCalc_obj::smoothBrain(hand_npsOne,( (Float)(0) ));
HXLINE( 235)				::DiffCalc_obj::smoothBrain(hand_npsTwo,( (Float)(0) ));
HXLINE( 237)				::DiffCalc_obj::smoothBrainTwo(hand_diffOne);
HXLINE( 238)				::DiffCalc_obj::smoothBrainTwo(hand_diffTwo);
            			}
HXLINE( 233)			{
HXLINE( 234)				::DiffCalc_obj::smoothBrain(hand_npsOne,( (Float)(0) ));
HXLINE( 235)				::DiffCalc_obj::smoothBrain(hand_npsTwo,( (Float)(0) ));
...
HXLINE( 247)		::Array< Float > point_npsOne = ::Array_obj< Float >::__new();
HXLINE( 248)		::Array< Float > point_npsTwo = ::Array_obj< Float >::__new();
HXLINE( 250)		{
HXLINE( 250)			int _g20 = 0;
HXDLIN( 250)			while((_g20 < segmentsOne->length)){
HXLINE( 250)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsOne,_g20)) );
HXDLIN( 250)				_g20 = (_g20 + 1);
HXLINE( 252)				if (::hx::IsNull( i )) {
HXLINE( 253)					continue;
            				}
HXLINE( 254)				point_npsOne->push(i->length);
            			}
            		}
HXLINE( 256)		{
HXLINE( 256)			int _g21 = 0;
HXDLIN( 256)			while((_g21 < segmentsTwo->length)){
HXLINE( 256)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,_g21)) );
HXDLIN( 256)				_g21 = (_g21 + 1);
HXLINE( 258)				if (::hx::IsNull( i )) {
HXLINE( 259)					continue;
            				}
HXLINE( 260)				point_npsTwo->push(i->length);
            			}
            		}
HXLINE( 263)		Float maxPoints = ( (Float)(0) );
HXLINE( 265)		{
HXLINE( 265)			int _g22 = 0;
HXDLIN( 265)			while((_g22 < point_npsOne->length)){
HXLINE( 265)				Float i = point_npsOne->__get(_g22);
HXDLIN( 265)				_g22 = (_g22 + 1);
HXLINE( 266)				maxPoints = (maxPoints + i);
            			}
            		}
HXLINE( 267)		{
HXLINE( 267)			int _g23 = 0;
HXDLIN( 267)			while((_g23 < point_npsTwo->length)){
HXLINE( 267)				Float i = point_npsTwo->__get(_g23);
HXDLIN( 267)				_g23 = (_g23 + 1);
HXLINE( 268)				maxPoints = (maxPoints + i);
            			}
            		}
HXLINE( 270)		if (::hx::IsGreater( accuracy,((Float).965) )) {
HXLINE( 271)			accuracy = ((Float).965);
            		}
HXLINE( 273)		::DiffCalc_obj::lastDiffHandOne = hand_diffOne;
HXLINE( 274)		::DiffCalc_obj::lastDiffHandTwo = hand_diffTwo;
HXLINE( 277)		return ::HelperFunctions_obj::truncateFloat(::DiffCalc_obj::chisel(( (Float)(accuracy) ),hand_diffOne,hand_diffTwo,point_npsOne,point_npsTwo,maxPoints),2);
            	}
...
Float DiffCalc_obj::chisel(Float scoreGoal,::Array< Float > diffOne,::Array< Float > diffTwo,::Array< Float > pointsOne,::Array< Float > pointsTwo,Float maxPoints){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_281_chisel)
HXLINE( 282)		Float lowerBound = ( (Float)(0) );
HXLINE( 283)		Float upperBound = ( (Float)(100) );
HXLINE( 285)		while(((upperBound - lowerBound) > ((Float)0.01))){
HXLINE( 287)			Float average = ((upperBound + lowerBound) / ( (Float)(2) ));
HXLINE( 288)			Float amtOfPoints = ::DiffCalc_obj::calcuate(average,diffOne,pointsOne);
HXDLIN( 288)			Float amtOfPoints1 = (amtOfPoints + ::DiffCalc_obj::calcuate(average,diffTwo,pointsTwo));
HXLINE( 289)			if (((amtOfPoints1 / maxPoints) < scoreGoal)) {
HXLINE( 290)				lowerBound = average;
            			}
            			else {
HXLINE( 292)				upperBound = average;
            			}
            		}
HXLINE( 295)		return upperBound;
            	}
...
Float DiffCalc_obj::calcuate(Float midPoint,::Array< Float > diff,::Array< Float > points){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_299_calcuate)
HXLINE( 300)		Float output = ( (Float)(0) );
HXLINE( 302)		{
HXLINE( 302)			int _g = 0;
HXDLIN( 302)			int _g1 = diff->length;
HXDLIN( 302)			while((_g < _g1)){
HXLINE( 302)				_g = (_g + 1);
HXDLIN( 302)				int i = (_g - 1);
HXLINE( 304)				Float res = diff->__get(i);
HXLINE( 305)				if ((midPoint > res)) {
HXLINE( 306)					output = (output + points->__get(i));
            				}
            				else {
HXLINE( 308)					output = (output + (points->__get(i) * ::Math_obj::pow((midPoint / res),((Float)1.2))));
            				}
            			}
            		}
HXLINE( 310)		return output;
            	}
...
int DiffCalc_obj::findStupid(Float strumTime,::Array< Float > array){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_314_findStupid)
HXLINE( 315)		{
HXLINE( 315)			int _g = 0;
HXDLIN( 315)			int _g1 = array->length;
HXDLIN( 315)			while((_g < _g1)){
HXLINE( 315)				_g = (_g + 1);
HXDLIN( 315)				int i = (_g - 1);
HXLINE( 316)				if ((array->__get(i) == strumTime)) {
HXLINE( 317)					return i;
            				}
            			}
            		}
...
Float DiffCalc_obj::fingieCalc(::Array< ::Dynamic> floats,::Array< Float > columArray){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_322_fingieCalc)
HXLINE( 323)		Float sum = ( (Float)(0) );
HXLINE( 324)		if ((floats->length == 0)) {
HXLINE( 325)			return ( (Float)(0) );
            		}
HXLINE( 326)		int startIndex = ::DiffCalc_obj::findStupid(floats->__get(0).StaticCast<  ::SmallNote >()->strumTime,columArray);
HXLINE( 327)		if ((startIndex == -1)) {
HXLINE( 328)			return ( (Float)(0) );
            		}
HXLINE( 329)		{
HXLINE( 329)			int _g = 0;
HXDLIN( 329)			while((_g < floats->length)){
HXLINE( 329)				 ::SmallNote i = floats->__get(_g).StaticCast<  ::SmallNote >();
HXDLIN( 329)				_g = (_g + 1);
HXLINE( 331)				sum = (sum + (columArray->__get((startIndex + 1)) - columArray->__get(startIndex)));
HXLINE( 332)				startIndex = (startIndex + 1);
            			}
            		}
HXLINE( 335)		if ((sum == 0)) {
HXLINE( 336)			return ( (Float)(0) );
            		}
HXLINE( 338)		return (( (Float)((1375 * floats->length)) ) / sum);
            	}
...
void DiffCalc_obj::smoothBrain(::Array< Float > npsVector,Float weirdchamp){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_344_smoothBrain)
HXLINE( 345)		Float floatOne = weirdchamp;
HXLINE( 346)		Float floatTwo = weirdchamp;
HXLINE( 348)		{
HXLINE( 348)			int _g = 0;
HXDLIN( 348)			int _g1 = npsVector->length;
HXDLIN( 348)			while((_g < _g1)){
HXLINE( 348)				_g = (_g + 1);
HXDLIN( 348)				int i = (_g - 1);
HXLINE( 350)				Float result = npsVector->__get(i);
HXLINE( 352)				Float chunker = floatOne;
HXLINE( 353)				floatOne = floatTwo;
HXLINE( 354)				floatTwo = result;
HXLINE( 356)				npsVector[i] = (((chunker + floatOne) + floatTwo) / ( (Float)(3) ));
            			}
            		}
            	}
...
void DiffCalc_obj::smoothBrainTwo(::Array< Float > diffVector){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_362_smoothBrainTwo)
HXLINE( 363)		Float floatZero = ( (Float)(0) );
HXLINE( 365)		{
HXLINE( 365)			int _g = 0;
HXDLIN( 365)			int _g1 = diffVector->length;
HXDLIN( 365)			while((_g < _g1)){
HXLINE( 365)				_g = (_g + 1);
HXDLIN( 365)				int i = (_g - 1);
HXLINE( 367)				Float result = diffVector->__get(i);
HXLINE( 369)				Float fuck = floatZero;
HXLINE( 370)				floatZero = result;
HXLINE( 371)				diffVector[i] = ((fuck + floatZero) / ( (Float)(2) ));
            			}
            		}
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_fc55aba1ba34c432_789_new,"BotPlay","new",0x2cacc9ed,"BotPlay.new","Options.hx",789,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_795_press,"BotPlay","press",0x783c8a50,"BotPlay.press","Options.hx",795,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_803_updateDisplay,"BotPlay","updateDisplay",0xe1e3db06,"BotPlay.updateDisplay","Options.hx",803,0x9d9a0240)

void BotPlay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_789_new)
HXLINE( 790)		super::__construct();
HXLINE( 791)		this->description = desc;
            	}
...
bool BotPlay_obj::press(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_795_press)
HXLINE( 796)		::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 798)		this->display = this->updateDisplay();
HXLINE( 799)		return true;
            	}


::String BotPlay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_803_updateDisplay)
HXDLIN( 803)		::String _hx_tmp;
HXDLIN( 803)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXDLIN( 803)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 803)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 803)		return (HX_("BotPlay ",45,3c,f1,7f) + _hx_tmp);
            	}

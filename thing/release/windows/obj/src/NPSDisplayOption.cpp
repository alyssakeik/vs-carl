...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_655_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",655,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_661_press,"NPSDisplayOption","press",0x231a9fdb,"NPSDisplayOption.press","Options.hx",661,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_669_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",669,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_655_new)
HXLINE( 656)		super::__construct();
HXLINE( 657)		this->description = desc;
            	}
...
bool NPSDisplayOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_661_press)
HXLINE( 662)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 663)		this->display = this->updateDisplay();
HXLINE( 664)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_669_updateDisplay)
HXDLIN( 669)		::String _hx_tmp;
HXDLIN( 669)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN( 669)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 669)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 669)		return (HX_("NPS Display ",ed,73,73,03) + _hx_tmp);
            	}

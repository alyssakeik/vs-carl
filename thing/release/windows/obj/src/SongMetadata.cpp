...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_610_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",610,0x0d86f62d)
...
void SongMetadata_obj::__construct(::String song,int week,::String songCharacter, ::smTools::SMFile sm,::String __o_path){
            	...
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_610_new)
HXLINE( 620)		this->diffs = ::Array_obj< ::String >::__new(0);
HXLINE( 618)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 613)		this->week = 0;
HXLINE( 612)		this->songName = HX_("",00,00,00,00);
HXLINE( 625)		this->songName = song;
HXLINE( 626)		this->week = week;
HXLINE( 627)		this->songCharacter = songCharacter;
HXLINE( 628)		this->sm = sm;
HXLINE( 629)		this->path = path;
            	}

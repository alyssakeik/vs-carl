...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_97_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",97,0x01fbc1e7)
...
HXLINE( 107)		this->isEnding = false;
...
HXLINE(  27)			daBf = HX_("bf-carl-dead",70,e1,fe,6e);
            		}
...
HXLINE(  76)			::PlayState_obj::stageTesting = false;
            		}
...
HXLINE(  81)			::flixel::FlxG_obj::camera->follow(this->camFollow,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),((Float)0.01));
            		}
HXLINE(  84)		bool _hx_tmp1;
HXDLIN(  84)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  84)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  86)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
HXLINE(  87)			this->startVibin = true;
            		}
HXLINE(  90)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE(  92)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_97_beatHit)
HXLINE(  98)		this->super::beatHit();
HXLINE( 100)		bool _hx_tmp;
HXDLIN( 100)		if (this->startVibin) {
HXLINE( 100)			_hx_tmp = !(this->isEnding);
            		}
            		else {
HXLINE( 100)			_hx_tmp = false;
            		}
HXDLIN( 100)		if (_hx_tmp) {
HXLINE( 102)			this->bf->playAnim(HX_("deathLoop",b8,0b,79,2e),true,null(),null());
            		}
            	}
...
HXLINE( 123)					::PlayState_obj::stageTesting = false;
            				}
...
HXLINE( 113)			::PlayState_obj::startTime = ( (Float)(0) );

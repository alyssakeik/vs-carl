...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_96_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",96,0x087e5c05)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_113_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",113,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_118_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",118,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_123_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",123,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_128_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",128,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_133_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",133,0x087e5c05)
...
HXLINE(  27)		this->startFullscreen = false;
HXLINE(  26)		this->skipSplash = true;
HXLINE(  25)		this->framerate = 120;
HXLINE(  24)		this->zoom = ((Float)-1);
HXLINE(  23)		this->initialState = ::hx::ClassOf< ::TitleState >();
...
HXLINE(  47)			this->init(null());
            		}
            		else {
HXLINE(  51)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::setupGame(){
            		...
            		void _hx_run(int exitCode){
            			HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_96_setupGame)
HXLINE(  96)			::DiscordClient_obj::shutdown();
            		}
...
HXLINE(  86)		this->initialState = ::hx::ClassOf< ::Caching >();
HXLINE(  87)		this->game =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen);
HXLINE(  91)		this->addChild(this->game);
HXLINE(  93)		::DiscordClient_obj::initialize();
HXLINE(  95)		::lime::app::Application_obj::current->onExit->add( ::Dynamic(new _hx_Closure_0()),null(),null());
HXLINE( 102)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 103)		this->addChild(this->fpsCounter);
HXLINE( 104)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_113_toggleFPS)
HXDLIN( 113)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_118_changeFPSColor)
HXDLIN( 118)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_123_setFPSCap)
HXDLIN( 123)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_128_getFPSCap)
HXDLIN( 128)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_133_getFPS)
HXDLIN( 133)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}

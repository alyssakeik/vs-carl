...
HX_DEFINE_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_489_new,"ScoreScreen","new",0x96db9c30,"ScoreScreen.new","Options.hx",489,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_495_press,"ScoreScreen","press",0xe976b353,"ScoreScreen.press","Options.hx",495,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_503_updateDisplay,"ScoreScreen","updateDisplay",0x3fc33f09,"ScoreScreen.updateDisplay","Options.hx",503,0x9d9a0240)

void ScoreScreen_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_489_new)
...
bool ScoreScreen_obj::press(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_495_press)
HXLINE( 496)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreScreen",5e,6c,c3,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String ScoreScreen_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_503_updateDisplay)
HXDLIN( 503)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )) {
HXDLIN( 503)			return HX_("Show Score Screen",9d,cf,bf,e6);
            		}
            		else {
HXDLIN( 503)			return HX_("No Score Screen",d9,d1,47,3c);
            		}

...
HXLINE(  59)		this->pastX = x;
HXLINE(  60)		this->pastY = y;
HXLINE(  63)		this->xScale = xScale;
HXLINE(  64)		this->yScale = yScale;
HXLINE(  66)		super::__construct(x,y,null());
HXLINE(  68)		this->_finalText = text;
HXLINE(  69)		this->text = text;
HXLINE(  70)		this->isBold = ( (bool)(bold) );
HXLINE(  72)		if ((text != HX_("",00,00,00,00))) {
HXLINE(  74)			if (typed) {
HXLINE(  76)				this->startTypedText();
            			}
            			else {
HXLINE(  80)				this->addText();
            			}
            		}
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_147_update,"LoadReplayState","update",0x971f8073,"LoadReplayState.update","LoadReplayState.hx",147,0xb45e587a)
...
HXLINE(  59)		{
HXLINE(  59)			int _g = 0;
HXDLIN(  59)			int _g1 = this->controlsStrings->length;
HXDLIN(  59)			while((_g < _g1)){
HXLINE(  59)				_g = (_g + 1);
HXDLIN(  59)				int i = (_g - 1);
HXLINE(  61)				::String string = this->controlsStrings->__get(i);
HXLINE(  62)				this->actualNames[i] = string;
HXLINE(  63)				 ::Replay rep = ::Replay_obj::LoadReplay(string);
HXLINE(  64)				::Array< ::String > _hx_tmp = this->controlsStrings;
HXDLIN(  64)				::String _hx_tmp1 = (string.split(HX_("time",0d,cc,fc,4c))->__get(0) + HX_(" ",20,00,00,00));
HXDLIN(  64)				_hx_tmp[i] = (_hx_tmp1 + ::CoolUtil_obj::difficultyFromInt(( (int)(rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) )).toUpperCase());
            			}
            		}
HXLINE(  67)		if ((this->controlsStrings->length == 0)) {
HXLINE(  68)			this->controlsStrings->push(HX_("No Replays...",81,d1,ed,00));
            		}
...
HXLINE(  74)		menuBG1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXLINE(  80)		{
HXLINE(  80)			int _g2 = 0;
HXDLIN(  80)			int _g3 = this->controlsStrings->length;
HXDLIN(  80)			while((_g2 < _g3)){
HXLINE(  80)				_g2 = (_g2 + 1);
HXDLIN(  80)				int i = (_g2 - 1);
HXLINE(  82)				 ::Alphabet controlLabel =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->controlsStrings->__get(i),true,false,null(),null(),null());
...
HXLINE(  90)		this->versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 34),0,HX_("Replay Loader (ESCAPE TO GO BACK)\nNOTICE!!!! Replays are in a beta stage, and they are probably not 100% correct. expect misses and other stuff that isn't there!\n",52,06,06,66),12,null());
...
HXLINE(  96)		this->poggerDetails =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,34,0,HX_("Replay Details - \nnone",38,c3,7c,19),12,null());
HXLINE(  97)		this->poggerDetails->scrollFactor->set(null(),null());
HXLINE(  98)		this->poggerDetails->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  99)		this->add(this->poggerDetails);
HXLINE( 101)		this->changeSelection(0);
...
HXLINE( 118)				 ::SongMetadata pog = this->songs->__get(i).StaticCast<  ::SongMetadata >();
...
HXDLIN( 127)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter,null(),null()));
            	}
...
void LoadReplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_147_update)
HXLINE( 148)		this->super::update(elapsed);
HXLINE( 150)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 151)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 151)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 151)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 152)		if (::PlayerSettings_obj::player1->controls->_upP->check()) {
...
HXLINE( 158)			_hx_tmp = (Dynamic( this->grpControls->members->__get(this->curSelected)).StaticCast<  ::Alphabet >()->text != HX_("No Replays...",81,d1,ed,00));
            		}
            		else {
HXLINE( 158)			_hx_tmp = false;
            		}
HXDLIN( 158)		if (_hx_tmp) {
HXLINE( 161)			::PlayState_obj::rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 163)			::PlayState_obj::loadRep = true;
HXLINE( 165)			if (::hx::IsEq( ::PlayState_obj::rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 169)				::String songFormat = ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 170)				::String _hx_switch_0 = songFormat;
            				if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 171)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 171)					goto _hx_goto_23;
            				}
            				if (  (_hx_switch_0==HX_("M.I.L.F",1e,4e,41,0d)) ){
HXLINE( 173)					songFormat = HX_("Milf",f6,78,35,33);
HXDLIN( 173)					goto _hx_goto_23;
            				}
            				if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 172)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 172)					goto _hx_goto_23;
            				}
            				if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 175)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 175)					goto _hx_goto_23;
            				}
            				if (  (_hx_switch_0==HX_("m.i.l.f",9e,fe,da,ac)) ){
HXLINE( 177)					songFormat = HX_("Milf",f6,78,35,33);
HXDLIN( 177)					goto _hx_goto_23;
            				}
            				if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 176)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 176)					goto _hx_goto_23;
            				}
            				_hx_goto_23:;

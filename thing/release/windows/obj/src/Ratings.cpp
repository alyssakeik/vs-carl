...
static const Float _hx_array_data_2ab48d96_6[] = {
	166.0,135.0,90.0,45.0,
};
...
::Array< Float > Ratings_obj::timingWindows;
...
HXDLIN(  99)		Float diff1 = (::Math_obj::abs(noteDiff) / diff);
HXLINE( 100)		{
HXLINE( 100)			int _g = 0;
...
HXLINE( 102)				Float time = (::Ratings_obj::timingWindows->__get(index) * ::Conductor_obj::timeScale);
HXLINE( 103)				Float nextTime;
HXDLIN( 103)				if (((index + 1) > (::Ratings_obj::timingWindows->length - 1))) {
HXLINE( 103)					nextTime = ( (Float)(0) );
            				}
            				else {
...
HXLINE( 104)					_hx_tmp = (diff1 >= (nextTime * ::Conductor_obj::timeScale));
            				}
            				else {
...
bool Ratings_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
		if (HX_FIELD_EQ(inName,"timingWindows") ) { timingWindows=ioValue.Cast< ::Array< Float > >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo Ratings_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /* ::Array< Float > */ ,(void *) &Ratings_obj::timingWindows,HX_("timingWindows",19,b9,c8,ac)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXDLIN(  95)		timingWindows = ::Array_obj< Float >::fromData( _hx_array_data_2ab48d96_6,4);
            	}
}

...
HX_DEFINE_STACK_FRAME(_hx_pos_59e1436159e1af96_331_new,"FlashingLightsOption","new",0xa84c7996,"FlashingLightsOption.new","Options.hx",331,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_336_press,"FlashingLightsOption","press",0xdee63639,"FlashingLightsOption.press","Options.hx",336,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_344_updateDisplay,"FlashingLightsOption","updateDisplay",0xd86917ef,"FlashingLightsOption.updateDisplay","Options.hx",344,0x9d9a0240)

void FlashingLightsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_331_new)
HXLINE( 332)		super::__construct();
HXLINE( 333)		this->description = desc;
            	}
...
bool FlashingLightsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_336_press)
HXLINE( 337)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 338)		this->display = this->updateDisplay();
HXLINE( 339)		return true;
            	}


::String FlashingLightsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_344_updateDisplay)
HXDLIN( 344)		::String _hx_tmp;
HXDLIN( 344)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) ))) {
HXDLIN( 344)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 344)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 344)		return (HX_("Flashing Lights ",b5,a5,19,88) + _hx_tmp);
            	}

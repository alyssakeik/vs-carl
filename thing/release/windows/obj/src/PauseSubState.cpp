...
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_272_destroy,"PauseSubState","destroy",0xc2ba82f3,"PauseSubState.destroy","PauseSubState.hx",272,0x953dc7b7)
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_279_changeSelection,"PauseSubState","changeSelection",0x8f960fb5,"PauseSubState.changeSelection","PauseSubState.hx",279,0x953dc7b7)
...
HXLINE( 133)			songLowercase = HX_("milf",d6,4c,5c,48);
...
HXDLIN( 138)		if (::PlayState_obj::isSM) {
HXLINE( 138)			_hx_tmp1 = !(::PlayState_obj::isStoryMode);
            		}
            		else {
HXLINE( 138)			_hx_tmp1 = false;
            		}
HXDLIN( 138)		if (_hx_tmp1) {
HXLINE( 139)			songPath = ::PlayState_obj::pathToSm;
            		}
HXLINE( 142)		bool _hx_tmp2;
HXDLIN( 142)		if (!(::PlayerSettings_obj::player1->controls->_upP->check())) {
HXLINE( 142)			_hx_tmp2 = upPcontroller;
            		}
            		else {
...
HXDLIN( 147)			if (!(::PlayerSettings_obj::player1->controls->_downP->check())) {
HXLINE( 147)				_hx_tmp = downPcontroller;
            			}
            			else {
...
HXDLIN( 153)				if (!(::PlayerSettings_obj::player1->controls->_leftP->check())) {
HXLINE( 153)					_hx_tmp = leftPcontroller;
            				}
            				else {
...
HXDLIN( 156)					::PlayState_obj::songOffset = (::PlayState_obj::songOffset - ( (Float)(1) ));
...
HXLINE( 161)					if (!(this->offsetChanged)) {
HXLINE( 163)						this->grpMenuShit->clear();
HXLINE( 165)						this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_8,2);
HXLINE( 167)						{
HXLINE( 167)							int _g = 0;
HXDLIN( 167)							int _g1 = this->menuItems->length;
HXDLIN( 167)							while((_g < _g1)){
HXLINE( 167)								_g = (_g + 1);
HXDLIN( 167)								int i = (_g - 1);
HXLINE( 169)								 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null(),null(),null());
HXLINE( 170)								songText->isMenuItem = true;
HXLINE( 171)								songText->targetY = ( (Float)(i) );
HXLINE( 172)								this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            							}
            						}
HXLINE( 175)						this->changeSelection(null());
HXLINE( 177)						this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 178)						this->offsetChanged = true;
            					}
            				}
            				else {
HXLINE( 181)					bool _hx_tmp;
HXDLIN( 181)					if (!(::PlayerSettings_obj::player1->controls->_rightP->check())) {
HXLINE( 181)						_hx_tmp = rightPcontroller;
            					}
            					else {
HXLINE( 181)						_hx_tmp = true;
            					}
HXDLIN( 181)					if (_hx_tmp) {
HXLINE( 183)						oldOffset = ::PlayState_obj::songOffset;
HXLINE( 184)						 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN( 184)						::PlayState_obj::songOffset = (::PlayState_obj::songOffset + 1);
HXLINE( 185)						::sys::FileSystem_obj::rename(((songPath + oldOffset) + HX_(".offset",41,ee,1a,d9)),((songPath + ::PlayState_obj::songOffset) + HX_(".offset",41,ee,1a,d9)));
HXLINE( 186)						this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
HXLINE( 187)						if (!(this->offsetChanged)) {
HXLINE( 189)							this->grpMenuShit->clear();
HXLINE( 191)							this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_9,2);
HXLINE( 193)							{
HXLINE( 193)								int _g = 0;
HXDLIN( 193)								int _g1 = this->menuItems->length;
HXDLIN( 193)								while((_g < _g1)){
HXLINE( 193)									_g = (_g + 1);
HXDLIN( 193)									int i = (_g - 1);
HXLINE( 195)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null(),null(),null());
HXLINE( 196)									songText->isMenuItem = true;
HXLINE( 197)									songText->targetY = ( (Float)(i) );
HXLINE( 198)									this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            								}
            							}
HXLINE( 201)							this->changeSelection(null());
HXLINE( 203)							this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 204)							this->offsetChanged = true;
            						}
            					}
            				}
            			}
            		}
HXLINE( 209)		bool _hx_tmp3;
...
HXDLIN( 209)			_hx_tmp3 = !(_this->keyManager->checkStatus(18,_this->status));
            		}
            		else {
HXLINE( 209)			_hx_tmp3 = false;
            		}
HXDLIN( 209)		if (_hx_tmp3) {
HXLINE( 211)			::String daSelected = this->menuItems->__get(this->curSelected);
HXLINE( 214)			::String _hx_switch_1 = daSelected;
            			if (  (_hx_switch_1==HX_("Exit to menu",82,87,9a,a9)) ){
HXLINE( 230)				::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 231)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 233)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 234)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 235)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 237)				if (::PlayState_obj::loadRep) {
HXLINE( 239)					::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),false,::hx::paccDynamic);
HXLINE( 240)					::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
HXLINE( 241)					::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),false,::hx::paccDynamic);
            				}
HXLINE( 243)				::PlayState_obj::loadRep = false;
HXLINE( 244)				::PlayState_obj::stageTesting = false;
...
HXLINE( 255)				::PlayState_obj::instance->clean();
HXLINE( 257)				if (::PlayState_obj::isStoryMode) {
HXLINE( 258)					 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 258)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 258)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				else {
HXLINE( 260)					 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 219)				::PlayState_obj::startTime = ( (Float)(0) );
...
HXLINE( 226)				::PlayState_obj::instance->clean();
HXLINE( 227)				{
HXLINE( 227)					 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 227)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 227)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
HXLINE( 228)				::PlayState_obj::stageTesting = false;
...
HXDLIN( 264)		bool _hx_tmp4 = _this->keyManager->checkStatus(74,_this->status);
            	}


void PauseSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_272_destroy)
...
void PauseSubState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_279_changeSelection)
HXLINE( 280)		 ::PauseSubState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 280)		_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 282)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 282)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 284)		if ((this->curSelected < 0)) {
HXLINE( 285)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 286)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 287)			this->curSelected = 0;
            		}
HXLINE( 289)		int bullShit = 0;
HXLINE( 291)		{
HXLINE( 291)			int _g = 0;
HXDLIN( 291)			::Array< ::Dynamic> _g1 = this->grpMenuShit->members;
HXDLIN( 291)			while((_g < _g1->length)){
HXLINE( 291)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 291)				_g = (_g + 1);
HXLINE( 293)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 294)				bullShit = (bullShit + 1);
HXLINE( 296)				item->set_alpha(((Float)0.6));
HXLINE( 299)				if ((item->targetY == 0)) {
HXLINE( 301)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}

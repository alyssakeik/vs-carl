...
HX_DEFINE_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_351_new,"AntialiasingOption","new",0x1e0e5b1b,"AntialiasingOption.new","Options.hx",351,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_356_press,"AntialiasingOption","press",0xb20742fe,"AntialiasingOption.press","Options.hx",356,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_364_updateDisplay,"AntialiasingOption","updateDisplay",0xd93bf1b4,"AntialiasingOption.updateDisplay","Options.hx",364,0x9d9a0240)

void AntialiasingOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_351_new)
HXLINE( 352)		super::__construct();
HXLINE( 353)		this->description = desc;
            	}
...
bool AntialiasingOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_356_press)
HXLINE( 357)		::flixel::FlxG_obj::save->data->__SetField(HX_("antialiasing",f4,16,b3,48),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 358)		this->display = this->updateDisplay();
HXLINE( 359)		return true;
            	}


::String AntialiasingOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_364_updateDisplay)
HXDLIN( 364)		::String _hx_tmp;
HXDLIN( 364)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ))) {
HXDLIN( 364)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 364)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 364)		return (HX_("Antialiasing ",8c,4e,f1,9b) + _hx_tmp);
            	}

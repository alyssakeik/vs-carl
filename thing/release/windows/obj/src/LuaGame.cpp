...
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1716_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1716,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1720_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1720,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1728_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1728,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1736_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1736,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1740_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1740,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1708_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1708,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1772_SetNumProperty,"LuaGame","SetNumProperty",0x2c9e2e9d,"LuaGame.SetNumProperty","LuaClass.hx",1772,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1785_Register,"LuaGame","Register",0x8cab5dc7,"LuaGame.Register","LuaClass.hx",1785,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1749_changeStage,"LuaGame","changeStage",0x1a987a6a,"LuaGame.changeStage","LuaClass.hx",1749,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1770_boot,"LuaGame","boot",0x47fd8d76,"LuaGame.boot","LuaClass.hx",1770,0xe0a4e33e)

void LuaGame_obj::__construct(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1716_new)
HXLINE(1717)			lua_pushnumber(l,::PlayState_obj::instance->health);
HXLINE(1718)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1720_new)
HXLINE(1721)			::PlayState_obj::instance->health = lua_tonumber(l,3);
HXLINE(1722)			return 0;
            		...
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1728_new)
HXLINE(1729)			lua_pushnumber(l,::PlayState_obj::instance->accuracy);
HXLINE(1730)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_3) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1736_new)
HXLINE(1737)			linc::lua::pushcfunction(l,::LuaGame_obj::changeStageC);
HXLINE(1738)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_4) HXARGC(1)
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1740_new)
HXLINE(1741)			linc::lual::error(l,HX_("changeStage is read-only.",cf,79,85,d3));
HXLINE(1742)			return 0;
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1708_new)
HXLINE(1709)		super::__construct();
HXLINE(1710)		this->className = HX_("Game",12,20,38,2f);
HXLINE(1712)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(1712)		_g->set(HX_("health",9c,28,06,fd), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1712)		_g->set(HX_("accuracy",39,06,c5,ff), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1712)		_g->set(HX_("changeStage",2e,13,d1,a9), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1712)		this->properties = _g;
            	}
...
int LuaGame_obj::SetNumProperty( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1772_SetNumProperty)
HXLINE(1777)		if ((lua_type(l,3) != 3)) {
HXLINE(1778)			linc::lual::error(l,((HX_("invalid argument #3 (number expected, got ",25,84,c0,d9) + linc::lua::_typename(l,lua_type(l,3))) + HX_(")",29,00,00,00)));
HXLINE(1779)			return 0;
            		}
HXLINE(1781)		 ::lime::ui::Window _hx_tmp = ::lime::app::Application_obj::current->_hx___window;
HXDLIN(1781)		::String _hx_tmp1 = linc::lua::tostring(l,2);
HXDLIN(1781)		::Reflect_obj::setProperty(_hx_tmp,_hx_tmp1,lua_tonumber(l,3));
HXLINE(1782)		return 0;
            	}
...
void LuaGame_obj::Register( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1785_Register)
HXLINE(1786)		::LuaGame_obj::state = l;
HXLINE(1787)		this->super::Register(l);
            	}
...
int LuaGame_obj::changeStage( lua_State* l){
            	HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1749_changeStage)
HXLINE(1752)		::String stageName = linc::lual::checkstring(::LuaGame_obj::state,2);
HXLINE(1754)		{
HXLINE(1754)			int _g = 0;
HXDLIN(1754)			::cpp::VirtualArray _g1 = ::PlayState_obj::Stage->toAdd;
HXDLIN(1754)			while((_g < _g1->get_length())){
HXLINE(1754)				 ::Dynamic i = _g1->__get(_g);
HXDLIN(1754)				_g = (_g + 1);
HXLINE(1756)				::PlayState_obj::instance->remove(i,null()).StaticCast<  ::flixel::FlxBasic >();
            			}
            		}
HXLINE(1759)		::PlayState_obj::Stage =  ::Stage_obj::__alloc( HX_CTX ,stageName);
HXLINE(1761)		{
HXLINE(1761)			int _g2 = 0;
HXDLIN(1761)			::cpp::VirtualArray _g3 = ::PlayState_obj::Stage->toAdd;
HXDLIN(1761)			while((_g2 < _g3->get_length())){
HXLINE(1761)				 ::Dynamic i = _g3->__get(_g2);
HXDLIN(1761)				_g2 = (_g2 + 1);
HXLINE(1763)				::PlayState_obj::instance->add(i).StaticCast<  ::flixel::FlxBasic >();
            			}
            		}
HXLINE(1766)		return 0;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1770_boot)
HXDLIN(1770)		changeStageC = ::cpp::Function< int ( lua_State*)>(::hx::AnyCast(&::LuaGame_obj::changeStage ));
            	}
}

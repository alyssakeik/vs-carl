...
HX_DEFINE_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_230_new,"DistractionsAndEffectsOption","new",0x025cdf63,"DistractionsAndEffectsOption.new","Options.hx",230,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_235_press,"DistractionsAndEffectsOption","press",0x2a356946,"DistractionsAndEffectsOption.press","Options.hx",235,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_243_updateDisplay,"DistractionsAndEffectsOption","updateDisplay",0x58e59ffc,"DistractionsAndEffectsOption.updateDisplay","Options.hx",243,0x9d9a0240)

void DistractionsAndEffectsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_230_new)
...
bool DistractionsAndEffectsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_235_press)
HXLINE( 236)		::flixel::FlxG_obj::save->data->__SetField(HX_("distractions",31,13,7d,60),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String DistractionsAndEffectsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_243_updateDisplay)
HXDLIN( 243)		::String _hx_tmp;
HXDLIN( 243)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) ))) {
HXDLIN( 243)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 243)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 243)		return (HX_("Distractions ",af,07,e4,54) + _hx_tmp);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_290_new,"ResetButtonOption","new",0xc052ff48,"ResetButtonOption.new","Options.hx",290,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_295_press,"ResetButtonOption","press",0xe9df0c6b,"ResetButtonOption.press","Options.hx",295,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0bd54ba2a6db792a_303_updateDisplay,"ResetButtonOption","updateDisplay",0x9c4e7021,"ResetButtonOption.updateDisplay","Options.hx",303,0x9d9a0240)

void ResetButtonOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_290_new)
...
bool ResetButtonOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_295_press)
HXLINE( 296)		::flixel::FlxG_obj::save->data->__SetField(HX_("resetButton",21,e5,f4,79),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 297)		this->display = this->updateDisplay();
HXLINE( 298)		return true;
            	}


::String ResetButtonOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0bd54ba2a6db792a_303_updateDisplay)
HXDLIN( 303)		::String _hx_tmp;
HXDLIN( 303)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("resetButton",21,e5,f4,79),::hx::paccDynamic)) ))) {
HXDLIN( 303)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 303)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 303)		return (HX_("Reset Button ",5d,3e,f2,5c) + _hx_tmp);
            	}

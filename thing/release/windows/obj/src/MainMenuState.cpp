...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_109_create,"MainMenuState","create",0x6b76e271,"MainMenuState.create","MainMenuState.hx",109,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_142_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",142,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_240_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",240,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_259_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",259,0x0e5db805)
...
HXLINE( 139)		this->selectedSomethin = false;
...
HXLINE(  66)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-100,null(),null());
HXDLIN(  66)		::String library = null();
HXDLIN(  66)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBG",24,65,6d,05)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  67)		bg1->scrollFactor->set_x(( (Float)(0) ));
HXLINE(  68)		bg1->scrollFactor->set_y(((Float)0.10));
HXLINE(  69)		bg1->setGraphicSize(::Std_obj::_hx_int((bg1->get_width() * ((Float)1.1))),null());
HXLINE(  70)		bg1->updateHitbox();
HXLINE(  71)		bg1->screenCenter(null());
HXLINE(  72)		bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  73)		this->add(bg1);
HXLINE(  75)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  76)		this->add(this->camFollow);
HXLINE(  78)		 ::flixel::FlxSprite _hx_tmp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  78)		::String library1 = null();
HXDLIN(  78)		this->magenta = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  79)		this->magenta->scrollFactor->set_x(( (Float)(0) ));
HXLINE(  80)		this->magenta->scrollFactor->set_y(((Float)0.10));
HXLINE(  81)		 ::flixel::FlxSprite _hx_tmp1 = this->magenta;
HXDLIN(  81)		_hx_tmp1->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.1))),null());
HXLINE(  82)		this->magenta->updateHitbox();
HXLINE(  83)		this->magenta->screenCenter(null());
HXLINE(  84)		this->magenta->set_visible(false);
HXLINE(  85)		this->magenta->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXLINE(  93)		::String library2 = null();
HXDLIN(  93)		bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN(  93)		::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("FNF_main_menu_assets",be,dc,57,e2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
HXDLIN(  93)		 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("FNF_main_menu_assets",be,dc,57,e2)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2));
HXLINE(  95)		{
HXLINE(  95)			int _g = 0;
HXDLIN(  95)			int _g1 = this->optionShit->length;
HXDLIN(  95)			while((_g < _g1)){
HXLINE(  95)				_g = (_g + 1);
HXDLIN(  95)				int i = (_g - 1);
HXLINE(  97)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.6)),null());
HXLINE(  98)				menuItem->set_frames(tex1);
HXLINE(  99)				menuItem->animation->addByPrefix(HX_("idle",14,a7,b3,45),(this->optionShit->__get(i) + HX_(" basic",8e,b6,25,79)),24,null(),null(),null());
HXLINE( 100)				menuItem->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),(this->optionShit->__get(i) + HX_(" white",89,d6,28,95)),24,null(),null(),null());
HXLINE( 101)				menuItem->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 102)				menuItem->ID = i;
HXLINE( 103)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 104)				this->menuItems->add(menuItem).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 105)				menuItem->scrollFactor->set(null(),null());
HXLINE( 106)				menuItem->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 107)				if (::MainMenuState_obj::firstStart) {
            					...
            					void _hx_run( ::flixel::tweens::FlxTween flxTween){
            						HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_109_create)
HXLINE( 110)						::MainMenuState_obj::finishedFunnyMove = true;
HXLINE( 111)						_gthis->changeItem(null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 108)					::flixel::tweens::FlxTween_obj::tween(menuItem, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 114)					menuItem->set_y(( (Float)((60 + (i * 160))) ));
            				}
            			}
            		}
HXLINE( 117)		::MainMenuState_obj::firstStart = false;
HXLINE( 119)		::flixel::FlxG_obj::camera->follow(this->camFollow,null(),(((Float)0.60) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))));
HXLINE( 121)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 18),0,::MainMenuState_obj::gameVer,12,null());
HXLINE( 122)		versionShit->scrollFactor->set(null(),null());
HXLINE( 123)		versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 124)		this->add(versionShit);
HXLINE( 129)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXLINE( 130)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),true);
            		}
            		else {
HXLINE( 132)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Duo(true),true);
            		}
HXLINE( 134)		this->changeItem(null());
...
HXLINE( 235)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_142_update)
HXLINE( 141)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 143)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 145)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 145)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 148)		if (!(this->selectedSomethin)) {
HXLINE( 150)			 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->lastActive;
HXLINE( 152)			if (::hx::IsNotNull( gamepad )) {
HXLINE( 154)				 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 154)				int id = 11;
HXDLIN( 154)				 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 154)				int Status = _this->status;
HXDLIN( 154)				bool _hx_tmp;
HXDLIN( 154)				switch((int)(id)){
            					case (int)-2: {
HXLINE( 154)						_hx_tmp = _this1->anyButton(Status);
            					}
            					break;
            					case (int)-1: {
HXLINE( 154)						_hx_tmp = !(_this1->anyButton(Status));
            					...
            					break;
            					default:{
HXLINE( 154)						int RawID = _this1->mapping->getRawID(id);
HXDLIN( 154)						 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 154)						if (::hx::IsNotNull( button )) {
HXLINE( 154)							_hx_tmp = button->hasState(Status);
            						}
            						else {
...
HXDLIN( 156)					_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 157)					this->changeItem(-1);
            				}
HXLINE( 159)				 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this2 = gamepad->justPressed;
HXDLIN( 159)				int id1 = 12;
HXDLIN( 159)				 ::flixel::input::gamepad::FlxGamepad _this3 = _this2->gamepad;
HXDLIN( 159)				int Status1 = _this2->status;
HXDLIN( 159)				bool _hx_tmp1;
HXDLIN( 159)				switch((int)(id1)){
            					case (int)-2: {
HXLINE( 159)						_hx_tmp1 = _this3->anyButton(Status1);
            					}
            					break;
            					case (int)-1: {
HXLINE( 159)						_hx_tmp1 = !(_this3->anyButton(Status1));
            					...
            					break;
            					default:{
HXLINE( 159)						int RawID = _this3->mapping->getRawID(id1);
HXDLIN( 159)						 ::flixel::input::gamepad::FlxGamepadButton button = _this3->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 159)						if (::hx::IsNotNull( button )) {
HXLINE( 159)							_hx_tmp1 = button->hasState(Status1);
            						}
            						else {
...
HXDLIN( 161)					_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
...
HXDLIN( 166)			if (_this->keyManager->checkStatus(38,_this->status)) {
...
HXLINE( 172)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 172)			if (_this1->keyManager->checkStatus(40,_this1->status)) {
HXLINE( 174)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 174)				_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 175)				this->changeItem(1);
            			}
HXLINE( 178)			if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 180)				 ::flixel::FlxState nextState =  ::TitleState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 185)				if ((this->optionShit->__get(this->curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 187)					this->fancyOpenURL(HX_("https://www.wendys.com/",18,fa,6d,7f));
            				}
            				else {
...
HXLINE( 199)						if ((_gthis->curSelected != spr->ID)) {
...
HXLINE( 211)							if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
...
HXLINE( 215)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 213)								::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            							}
            							else {
...
HXLINE( 222)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 220)								 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXLINE( 194)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 195)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 197)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_3(_gthis)),null());
            				}
            			}
            		}
HXLINE( 231)		this->super::update(elapsed);
HXLINE( 233)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_240_goToState)
HXLINE( 241)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 243)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 249)			 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 254)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 254)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 254)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 254)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("story mode",6e,d7,a7,5e)) ){
HXLINE( 246)			 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXDLIN( 273)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 273)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
...
HXLINE( 276)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 276)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 276)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
HXLINE( 279)			spr->animation->_curAnim->set_frameRate((( (Float)(24) ) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))));
HXLINE( 281)			spr->updateHitbox();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_259_changeItem)
HXLINE( 258)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 260)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 262)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 262)			_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 264)			if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 265)				this->curSelected = 0;
            			}
HXLINE( 266)			if ((this->curSelected < 0)) {
HXLINE( 267)				this->curSelected = (this->menuItems->length - 1);
            			}
            		}
HXLINE( 269)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
HXDLIN(  43)		kadeEngineVer = (HX_("",00,00,00,00) + ::MainMenuState_obj::nightly);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_44_boot)
HXDLIN(  44)		gameVer = HX_("Wendy's Parking Lot | BB V.2.0",76,30,31,b0);
            	}
{

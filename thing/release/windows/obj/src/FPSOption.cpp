...
HX_DEFINE_STACK_FRAME(_hx_pos_da44038d8b33767f_467_new,"FPSOption","new",0xd6c03010,"FPSOption.new","Options.hx",467,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_473_press,"FPSOption","press",0x5a8fff33,"FPSOption.press","Options.hx",473,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_482_updateDisplay,"FPSOption","updateDisplay",0x3edb6ae9,"FPSOption.updateDisplay","Options.hx",482,0x9d9a0240)

void FPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_467_new)
...
bool FPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_473_press)
HXLINE( 474)		::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 475)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
HXLINE( 476)		this->display = this->updateDisplay();
HXLINE( 477)		return true;
            	}


::String FPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_482_updateDisplay)
HXDLIN( 482)		::String _hx_tmp;
HXDLIN( 482)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ))) {
HXDLIN( 482)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 482)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 482)		return (HX_("FPS Counter ",fb,a4,fc,60) + _hx_tmp);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_0438001de6863180_250_new,"Colour","new",0x7d6b835e,"Colour.new","Options.hx",250,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_255_press,"Colour","press",0x81314201,"Colour.press","Options.hx",255,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_263_updateDisplay,"Colour","updateDisplay",0x69d12bb7,"Colour.updateDisplay","Options.hx",263,0x9d9a0240)

void Colour_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_250_new)
...
bool Colour_obj::press(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_255_press)
HXLINE( 256)		::flixel::FlxG_obj::save->data->__SetField(HX_("colour",4c,c8,86,c6),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 257)		this->display = this->updateDisplay();
HXLINE( 258)		return true;
            	}


::String Colour_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_263_updateDisplay)
HXDLIN( 263)		::String _hx_tmp;
HXDLIN( 263)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) ))) {
HXDLIN( 263)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 263)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 263)		return (HX_("Colored Health Bar ",33,6c,51,b6) + _hx_tmp);
            	}

...
class HXCPP_CLASS_ATTRIBUTES SongMetadata_obj : public ::hx::Object
{
	...
	public:
		...
		static ::hx::ObjectPtr< SongMetadata_obj > __new(::String song,int week,::String songCharacter, ::smTools::SMFile sm,::String __o_path);
		static ::hx::ObjectPtr< SongMetadata_obj > __alloc(::hx::Ctx *_hx_ctx,::String song,int week,::String songCharacter, ::smTools::SMFile sm,::String __o_path);

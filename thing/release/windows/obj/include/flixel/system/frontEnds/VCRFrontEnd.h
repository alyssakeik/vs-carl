...
HX_DECLARE_STACK_FRAME(_hx_pos_9c3075758433de87_17_new)
...
HXLINE(  55)		( ( ::flixel::_hx_system::frontEnds::VCRFrontEnd)(__this) )->stepRequested = false;
HXLINE(  50)		( ( ::flixel::_hx_system::frontEnds::VCRFrontEnd)(__this) )->paused = false;
            	}

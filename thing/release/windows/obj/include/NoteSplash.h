...
class HXCPP_CLASS_ATTRIBUTES NoteSplash_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct( ::Dynamic __o_fromNote,Float x,Float y);
		...
		static ::hx::ObjectPtr< NoteSplash_obj > __new( ::Dynamic __o_fromNote,Float x,Float y);
		static ::hx::ObjectPtr< NoteSplash_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic __o_fromNote,Float x,Float y);
		...
		void setupNoteSplash( ::Dynamic fromNote,Float x,Float y);

...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("VS Carl", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("VS Carl", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "VS Carl";
		app.meta["name"] = "Friday Night Funkin': VS Carl";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': VS Carl",
			width: 1280,
			x: null,
			y: null,
		};

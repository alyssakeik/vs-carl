...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		Assets.libraryPaths["carl"] = rootPath + "manifest/carl.json";
		...
		library = Assets.getLibrary ("carl");
		if (library != null) preloadLibraries.push (library);
		else preloadLibraryNames.push ("carl");
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_dialogueend_crystalizeddialogueend_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_dialogueend_dungeondialogueend_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_dialogueend_necromancipationdialogueend_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_dialogueend_raveyarddialogueend_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_crystalized_crystalized_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_crystalized_crystalized_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_crystalized_crystalized_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_crystalized_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_data_goes_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_dungeon_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_dungeon_dungeon_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_dungeon_dungeon_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_dungeon_dungeon_json extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_necromancipation_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_necromancipation_necromancipation_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_necromancipation_necromancipation_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_necromancipation_necromancipation_json extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_raveyard_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_raveyard_raveyard_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_raveyard_raveyard_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_raveyard_raveyard_json extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_fnfbbb_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_fnfbbb_xml extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_icons_icon_carl_phase_1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_icons_icon_carl_phase_2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_icons_icon_carl_phase_3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_wendys_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_crystalized_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_crystalized_voices_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_dungeon_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_dungeon_voices_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_necromancipation_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_necromancipation_voices_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_offsettest_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_raveyard_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_raveyard_voices_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_bf_carl_dead_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_bf_carl_dead_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_bf_carl_deadoffsets_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_1_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_1offsets_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_2_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_2offsets_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_3_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_characters_carl_phase_3offsets_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_carl_stuff_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_background_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_background_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_backgroundphase2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_backgroundphase2_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_backgroundthirdphase_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_backgroundthirdphase_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_carl_text_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_carl_text_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_congrats_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_cream_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_crowd_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_crowd_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_crystal_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_crystal_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_fixed_floor_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_fixed_floor_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_game_over_carl_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_game_over_carl_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_huge_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_huge_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_phase4shit_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_phase4shit_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_pile_obones_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_release_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_textboxes_carl_text_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_textboxes_carl_text_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_the_torch_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_carl_images_the_torch_xml extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__manifest_carl_json extends null { }
